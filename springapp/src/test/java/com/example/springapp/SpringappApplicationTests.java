...
class SpringappApplicationTests {
	...
	void test_case1() throws Exception{	
		...
		String st = "{\"songId\":1000,\"musicDirectorName\": \"Demo\",\"yearOfRelease\": 1998,\"songName\": \"ÄBCD\",\"movieName\": \"XYZ\"}";
	...
	void test_case2() throws Exception{	
		 ...
		 mockMvc.perform(get("/1000")
						...
						.andExpect(jsonPath("$.musicDirectorName").value("Demo"))
						.andReturn();
	}
	...
	void test_case3() throws Exception{	
		...
		String st = "{\"songId\":1000,\"musicDirectorName\": \"Demo1\",\"yearOfRelease\": 1999,\"songName\": \"ABCDE\",\"movieName\": \"XYZ1\"}";
